...
class ChangePasswordController extends GetxController {
  ...
  void visibleOldPassword() {
    ...
    visibleOldPassIcon =
        isVisibleOldPass ? Icons.visibility : Icons.visibility_off;
    update();
  }
  ...
  void visibleNewPassword() {
    ...
    visibleNewPassIcon =
        isVisibleNewPass ? Icons.visibility : Icons.visibility_off;
    update();
  }
  ...
  void resetPassword() {
    ...
    if (isValidate) {
      ...
      ApiRequests.resetPassword(
        ...
        Get.snackbar('Change password'.tr, 'Password Reset Done'.tr);
        Get.offAndToNamed(Routes.home);
        isLoading(false);
      }).catchError((error) {
        Get.snackbar(
            'Error changing password'.tr, 'The old password is incorrect'.tr);
