                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          '${Const.baseImagesUrl}${AppHelper.formateTeamImage(search.teamHome!.image!)}'))),
                            ),
                            Text(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          '${Const.baseImagesUrl}${AppHelper.formateTeamImage(search.teamAway!.image!)}'))),
                            ),
                            Text(
