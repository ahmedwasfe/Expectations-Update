...
class MyLocal implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          'subscription_package_text': 'ستسمح لك هذه الحزمة الشهرية ببدء قناة البث المباشر الخاصة بك. البث المباشر يعني فقط مشاركة توقعات المباريات الخاصة بك. في حالة الفوز ، ستتلقى رسالة نصية من الراعي. الباقة تتجدد شهريا',
          ...
          "en": {
            ...
            'subscription_package_text': 'This monthly package will allow you to start your own live streaming channel. The live streaming in meant only to share your matches expectations. In case of winning, you will receive a text message from our sponsor. The package is renewed monthly',
